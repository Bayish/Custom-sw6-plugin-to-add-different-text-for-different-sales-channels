...
class CustomTwigExtension extends AbstractExtension
{
    ...
    public function __construct(TranslatorInterface $translator, EntityRepository $snippetVariantRepository, EntityRepository $salesChannelRepository)
    {
        $this->translator = $translator;
        $this->snippetVariantRepository = $snippetVariantRepository;
